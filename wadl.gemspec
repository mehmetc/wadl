...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--title".freeze, "wadl Application documentation (v0.3.2)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
